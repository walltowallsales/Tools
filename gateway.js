...
const modules = [
  ...
  { slug: 'tags', title: 'Item - Sort Tags by Location', folder: 'tag-sort', port: 3106, version: 'v1.8' },
...
app.get('/health', (req, res) => res.json({ ok: true, suite: '1.18.0', modules: modules.map(m => m.slug) }));
