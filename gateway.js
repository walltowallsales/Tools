...
app.get('/health', (req, res) => res.json({ ok: true, suite: '1.1.0', modules: modules.map(m => m.slug) }));
...
for (const mod of modules) {
  app.use(`/${mod.slug}`, (req, res) => proxyTo(mod, req, res));
}
