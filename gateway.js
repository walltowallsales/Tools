...
const modules = [
  ...
  { slug: 'shipping', title: 'Shipping - Pick List', folder: 'pick', port: 3104, version: 'v30', data: 'pick' },
...
app.get('/health', (req, res) => res.json({ ok: true, suite: '1.22.0', modules: modules.map(m => m.slug) }));
