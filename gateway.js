...
const modules = [
  { slug: 'move', title: 'Item - Move or Update Qty', folder: 'location', port: 3101, version: 'v2.39' },
  ...
  { slug: 'tags', title: 'Item - Sort Tags by Location', folder: 'tag-sort', port: 3106, version: 'v1.9' },
...
app.get('/health', (req, res) => res.json({ ok: true, suite: '1.20.0', modules: modules.map(m => m.slug) }));
