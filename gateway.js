...
const modules = [
  { slug: 'move', title: 'Item - Move or Update Qty', folder: 'location', port: 3101, version: 'v2.35' },
...
app.get('/health', (req, res) => res.json({ ok: true, suite: '1.7.0', modules: modules.map(m => m.slug) }));
