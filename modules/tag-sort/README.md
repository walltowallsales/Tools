# Item - Sort Tags by Location v1.10

v1.10 preserves untagged Batch listings in the shared search index so Location Mover can find visible SellerChamp listing titles. Tag filtering and actions continue to use only records with the selected tag.
